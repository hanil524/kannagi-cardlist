...
const deckBuilder = {
  ...
  twoCardLimit: new Set(['悠習の古日記（ゆうしゅうのこにっき）', "本物のお化け屋敷（ほんもののおばけやしき）","つちのこ(ツチノコ)", "新府城（しんぶじょう）", "札絵れあ（ふだえれあ）", "血の視線（ちのしせん）", "死神の蝋燭（しにがみのろうそく）", "失われた海域(うしなわれたかいいき)", "赤津川（あかつがわ）", "いっしょにあそぼ・・・"]),
